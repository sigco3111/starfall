...
const EN: Record<string, string> = {
  ...
  // No-build category fallback (see registry lookup)
...
// Brand / proper nouns (Homeworld, Claude Opus 5, Mike Luan, Vite,
// TypeScript, Three.js, e01.ai, Rajdhani, JetBrains Mono, the ship
// codenames themselves) are kept verbatim.
// ────────────────────────────────────────────────────────────────
